  ...
  const projects: Project[] = [
    {
      ...
      technologies: ["Excel", "Power Query", "Power BI", "Pivot Charts", "Slicers", "Timelines", "Python"],
      ...
      gallery: [],
      embedUrl: "https://1drv.ms/x/c/fa3f0ea2daf0e4f7/IQQxkb4IXyc5QYAVyjTGIb-MAfvMcm16P1llBicbmCjhrSc"
    },
    {
